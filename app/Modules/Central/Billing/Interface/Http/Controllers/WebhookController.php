...
final class WebhookController extends Controller {
    public function handle(Request $request): Response {
        ...
        $verifier = app(\App\Modules\Central\Billing\Infrastructure\Gateways\PaymentGateway::class);
        // We temporarily swap the implementation to the correct gateway for verification
        $gatewayService = match ($gateway) {
            'dlocal' => app(\App\Modules\Central\Billing\Infrastructure\Gateways\DlocalGateway::class),
            default => app(\App\Modules\Central\Billing\Infrastructure\Gateways\ClaveGateway::class),
        };
