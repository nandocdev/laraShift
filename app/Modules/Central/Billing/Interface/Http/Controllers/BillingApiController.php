...
use App\Modules\Central\Billing\Application\Actions\CancelSubscription;
...
class BillingApiController extends Controller
{
     ...
     */
    public function checkout(Request $request, CreateCheckoutSession $action): JsonResponse
    {
        $request->validate([
     ...
     */
    public function cancelSubscription(Request $request, string $id, CancelSubscription $action): JsonResponse
    {
