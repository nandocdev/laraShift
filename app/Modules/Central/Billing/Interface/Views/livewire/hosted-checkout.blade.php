<div class="flex flex-col gap-6 py-12" x-data="smartFieldsCheckout()">
    ...
    <script>
        function smartFieldsCheckout() {
            return {
                processing: @entangle('processing'),
                fields: null,
                init() {
                    // dLocal Smart Fields: the PAN is tokenized in the browser
                    // and never touches our backend (see DlocalGateway).
