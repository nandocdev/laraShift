...
Route::middleware(['web', 'auth:central'])->group(function () {
    ...
    Route::get('/central/billing/checkout/paguelofacil', \App\Modules\Central\Billing\Livewire\PaguelofacilCheckout::class)->name('central.billing.checkout.paguelofacil');
