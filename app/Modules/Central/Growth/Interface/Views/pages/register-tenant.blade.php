        ...
        <div class="flex items-center justify-center mb-8">
            ...
            <div class="flex items-center">
                <div class="flex flex-col items-center">
                    <div @class([ 'w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300' , 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30'=> $step >= $num,
                    ...
                    <span @class([ 'mt-2 text-xs font-medium transition-colors' , 'text-indigo-600 dark:text-indigo-400'=> $step >= $num,
                        'text-zinc-400' => $step < $num,
                            ])>{{ $label }}</span>
                </div>
                @if($num < 3)
                    <div @class([ 'w-16 sm:w-24 h-0.5 mx-2 mb-6 transition-all duration-500' , 'bg-indigo-600'=> $step > $num,
        ...
        <div class="space-y-6" wire:key="step-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    @class([ 'relative cursor-pointer rounded-xl p-6 border-2 transition-all duration-200 hover:shadow-lg' , 'border-indigo-500 bg-indigo-50/50 dark:bg-indigo-950/20 shadow-md ring-1 ring-indigo-500/20'=> $plan_id === $plan->slug,
            ...
            <div class="rounded-lg bg-zinc-100 dark:bg-zinc-900 p-5 space-y-3">
                ...
                <div class="flex justify-between text-sm pt-2 border-t border-zinc-200 dark:border-zinc-800">
                    ...
                    <span class="font-bold text-indigo-600 dark:text-indigo-400 text-lg">
                        {{ \App\Modules\Platform\Data\Services\PriceFormatter::format($selectedPlan->price_monthly) }}
                    </span>
                </div>
