...
Route::middleware(['web', 'auth:central', 'can:tenants:view'])->group(function () {
    ...
    Route::get('/central/tenants/{tenant}/edit', ManageTenant::class)->name('central.provisioning.edit');
});
