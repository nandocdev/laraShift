<div class="flex flex-col gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <flux:card>
            <div class="flex flex-col gap-2">
                <flux:text size="sm" variant="subtle">{{ __('Total Revenue') }}</flux:text>
        ...
        <flux:card>
            <div class="flex flex-col gap-2">
                <flux:text size="sm" variant="subtle">{{ __('System Health') }}</flux:text>
                <flux:badge color="green" size="lg">{{ __('Stable') }}</flux:badge>
            </div>
        </flux:card>
    </div>
