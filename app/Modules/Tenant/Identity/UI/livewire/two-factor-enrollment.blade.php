    ...
    <flux:card>
        ...
        @elseif (! empty($recoveryCodes))
            <div class="space-y-6">
                ...
                <div class="flex justify-end">
                    <flux:button :href="route('dashboard')" wire:navigate>{{ __('I have saved these codes') }}</flux:button>
                </div>
            </div>
        @elseif ($showingQrCode)
            <div class="space-y-6 text-center">
                ...
                <div class="flex justify-center p-4 bg-white rounded-lg inline-block mx-auto shadow-sm">
                    {!! $qrCodeUrl !!}
                </div>

                <div class="max-w-xs mx-auto space-y-4 text-start">
