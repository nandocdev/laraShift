...
use App\Modules\Tenant\Access\Application\Actions\EnrollTenantMfa;
...
class TwoFactorEnrollment extends Component
{
    ...
    public function initiate(EnrollTenantMfa $action): void
    {
    ...
    public function confirm(EnrollTenantMfa $action): void
    {
        $this->validate([
