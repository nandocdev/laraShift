        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Administration')" class="grid">
                    <flux:sidebar.item icon="home" :href="route('central.dashboard')" :current="request()->routeIs('central.dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="server-stack" :href="route('central.provisioning.index')" :current="request()->routeIs('central.provisioning.*')" wire:navigate>
                        {{ __('Tenants') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
            ...
            <flux:sidebar.nav>
                <flux:sidebar.item icon="folder-git-2" href="https://github.com/nandocdev/Plinth" target="_blank">
                    {{ __('Project') }}
                </flux:sidebar.item>
